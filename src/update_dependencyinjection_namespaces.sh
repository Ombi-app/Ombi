#!/bin/bash
# Comprehensive script to update all using statements in the DependencyInjection project
echo "Updating using statements in DependencyInjection project..."
...
# Gotify
find Ombi.DependencyInjection -name "*.cs" -exec sed -i '' 's/Ombi\.Api\.Gotify/Ombi.Api.External.ExternalApis.Gotify/g' {} \;
# GroupMe
find Ombi.DependencyInjection -name "*.cs" -exec sed -i '' 's/Ombi\.Api\.GroupMe/Ombi.Api.External.ExternalApis.GroupMe/g' {} \;
# Webhook
find Ombi.DependencyInjection -name "*.cs" -exec sed -i '' 's/Ombi\.Api\.Webhook/Ombi.Api.External.ExternalApis.Webhook/g' {} \;
# Lidarr
...
# Slack
find Ombi.DependencyInjection -name "*.cs" -exec sed -i '' 's/Ombi\.Api\.Slack/Ombi.Api.External.ExternalApis.Slack/g' {} \;
# Telegram
find Ombi.DependencyInjection -name "*.cs" -exec sed -i '' 's/Ombi\.Api\.Telegram/Ombi.Api.External.ExternalApis.Telegram/g' {} \;
# MusicBrainz
find Ombi.DependencyInjection -name "*.cs" -exec sed -i '' 's/Ombi\.Api\.MusicBrainz/Ombi.Api.External.ExternalApis.MusicBrainz/g' {} \;
# Twilio
find Ombi.DependencyInjection -name "*.cs" -exec sed -i '' 's/Ombi\.Api\.Twilio/Ombi.Api.External.ExternalApis.Twilio/g' {} \;
# CloudService
find Ombi.DependencyInjection -name "*.cs" -exec sed -i '' 's/Ombi\.Api\.CloudService/Ombi.Api.External.ExternalApis.CloudService/g' {} \;
# RottenTomatoes
